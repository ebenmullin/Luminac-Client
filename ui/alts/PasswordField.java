...
public class PasswordField extends Gui {
    ...
    public void mouseClicked(final int par1, final int par2, final int par3) {
        ...
        if (this.isFocused && par3 == 0) {
            ...
            final String var6 = fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n), this.getWidth());
            this.setCursorPosition(fontRenderer.trimStringToWidth(var6, var5).length() + this.field_73816_n);
        }
    }
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            final String var4 = fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n), this.getWidth());
            ...
            if (var4.length() > 0) {
                ...
                var9 = fontRenderer.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), var7, var8, var1);
            }
            ...
            if (var6) {
                if (var10) {
                    Gui.drawRect(var11, var8 - 1, var11 + 1, var8 + 1, -3092272);
                }
                else {
            ...
            if (var3 != var2) {
                final int var12 = (int) (var7 + fontRenderer.getStringWidth(var4.substring(0, var3)));
    ...
    public void func_73800_i(int par1) {
        ...
        if (fontRenderer != null) {
            ...
            final String var4 = fontRenderer.trimStringToWidth(this.text.substring(this.field_73816_n), var3);
            final int var5 = var4.length() + this.field_73816_n;
            if (par1 == this.field_73816_n) {
                this.field_73816_n -= fontRenderer.trimStringToWidth(this.text, var3).length();
            }
            if (par1 > var5) {
