...
public class GuiAltManager extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) throws IOException {
        switch (button.id) {
            case 0: {
                ...
                this.loginThread.setStatus((Object)((Object)EnumChatFormatting.RED) + "Failed to login! Incorrect credentials!" + (Object)((Object)EnumChatFormatting.YELLOW) + " Logging in...");
                break;
            }
            case 1: {
    ...
    public void drawScreen(int par1, int par2, float par3) {
    	mc.getTextureManager().bindTexture(new ResourceLocation("luminac/mainMenu/wallpaper5.png"));
        drawModalRectWithCustomSizedTexture(0, 0, 0, 0, this.width, this.height, this.width, this.height);
    	
    	this.drawRect(width, 20, - width, 0, 0xff4a4a4a);
		this.drawRect(width, 20, - width, 18, -1);
		this.drawRect(width, height - 50, - width, height, 0xff4a4a4a);
        ...
        this.drawCenteredString(fontRendererObj, sb2.append(AltManager.registry.size()).append(" alts").toString(), width / 2, 9 - mc.fontRendererObj.FONT_HEIGHT/2, -1);
        ...
        for (Alt alt2 : AltManager.registry) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                    this.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -16777216);
