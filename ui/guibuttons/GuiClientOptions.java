...
public class GuiClientOptions extends GuiScreen {
    ...
    protected String guiName = "Client Options";
    private static final String __OBFID = "CL_00000700";

    public GuiClientOptions(GuiScreen p_i1046_1_, GameSettings p_i1046_2_) {
    ...
    public void initGui() {
        int var1 = 0;
        this.guiName = I18n.format("Client Options", new Object[0]);
        ...
        this.buttonList.add(new GuiButton(1, this.width / 2 - 155, this.height / 6 + 72 - 6, 150, 20, I18n.format("Credits", new Object[0])));
        this.buttonList.add(new GuiButton(2, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, I18n.format("Xray", new Object[0])));
        this.buttonList.add(new GuiButton(3, this.width / 2 - 155, this.height / 6 + 96 - 6, 150, 20, I18n.format("Search", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 5, this.height / 6 + 96 - 6, 150, 20, I18n.format("Friends", new Object[0])));
        this.buttonList.add(new GuiButton(5, this.width / 2 - 155, this.height / 6 + 120 - 6, 150, 20, I18n.format("Alts", new Object[0])));
        this.buttonList.add(new GuiButton(6, this.width / 2 + 5, this.height / 6 + 120 - 6, 150, 20, I18n.format("Discord", new Object[0])));
        this.buttonList.add(new GuiButton(7, this.width / 2 - 155, this.height / 6 + 144 - 6, 150, 20, I18n.format("Youtube", new Object[0])));
        this.buttonList.add(new GuiButton(8, this.width / 2 + 5, this.height / 6 + 144 - 6, 150, 20, I18n.format("Github", new Object[0])));
        this.buttonList.add(new GuiButton(9, this.width / 2 - 100, this.height / 6 + 168, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void confirmClicked(boolean result, int id) {
        ...
        if (id == 1 && result && this.mc.theWorld != null) {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            ...
            if (button.id == 2) {
            	//mc.displayGuiScreen((GuiScreen)new GuiXray());
            }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.guiName, this.width / 2, 15, 16777215);
