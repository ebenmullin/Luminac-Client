...
public abstract class GuiBlocksList implements GuiListExtended.IGuiListEntry {
    ...
    public GuiBlocksList(GuiScreenResourcePacks p_i45051_1_)
    {
...
/**
    ...
    protected boolean func_148314_g()
    {
        ...
        return var2 > 0 && ((GuiBlocksList)var1.get(var2 - 1)).func_148310_d();
    }
    ...
    protected boolean func_148307_h()
    {
        //List var1 = this.field_148315_b.func_146962_b(this);
        int var2 = var1.indexOf(this);
        return var2 >= 0 && var2 < var1.size() - 1 && ((GuiBlocksList)var1.get(var2 + 1)).func_148310_d();
    }
