...
public abstract class GuiSearch extends GuiListExtended {
    protected final Minecraft mc;
    protected final List field_148204_l;
    private static final String __OBFID = "CL_00000825";

    public GuiSearch(Minecraft mcIn, int p_i45055_2_, int p_i45055_3_, List p_i45055_4_) {
     ...
     * Gets the IGuiListEntry object for the given index
     */
    public IGuiListEntry getListEntry1(int p_148180_1_) {
